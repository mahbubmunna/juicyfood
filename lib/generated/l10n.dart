...
class S {
  ...
  String get doNotHaveAccountSignUp {
    return Intl.message(
      'Do not have Account? Sign Up',
      name: 'doNotHaveAccountSignUp',
      desc: '',
      args: [],
    );
  }
  ...
  String get emailForPasswordResetLink {
    return Intl.message(
      'Enter your email to reset',
      name: 'emailForPasswordResetLink',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Lorem ipsum dolor sit amet, consectetur non adipiscing elit. Etiam ac tempor leo.`
