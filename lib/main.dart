...
import 'package:juicyfood/route_generator.dart';
import 'package:dynamic_theme/dynamic_theme.dart';
import 'package:firebase_analytics/firebase_analytics.dart';
import 'package:firebase_analytics/observer.dart';
import 'package:flutter/material.dart';
import 'package:flutter_localizations/flutter_localizations.dart';
import 'package:juicyfood/config/app_config.dart' as config;
import 'package:juicyfood/src/repository/settings_repository.dart' as settingRepo;
        ...
        data: (brightness) {
          if (brightness == Brightness.light) {
            return ThemeData(
              ...
              secondaryHeaderColor: config.Colors().mainSecond(1),
              inputDecorationTheme: InputDecorationTheme(border: OutlineInputBorder(borderRadius: BorderRadius.all(Radius.circular(32)))),
              textTheme: TextTheme(
